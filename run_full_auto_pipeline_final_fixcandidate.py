# Fix candidate for the final pipeline write block
# Uses working writecheck output path and write logic, but real content generation
    ...
    if mode == 'event' and report.replace('_', ' ') in report_names:
        ...
        for i, bout in enumerate(bout_entries):
            ...
            if fight_report:
                ...
                # Use markdown renderer from recovered_embed
