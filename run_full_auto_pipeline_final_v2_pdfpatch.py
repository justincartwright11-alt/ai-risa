# Copy of fixcandidate for PDF patching
# Will patch PDF rendering for long lines and font issues
        ...
        if premium_sections or tba_sections:
            ...
            if fmt == 'pdf':
                try:
                    ...
                    pdf = FPDF()
                    pdf.add_page()
                    # Use a core font for compatibility
                        ...
                        for line in para.split("\n"):
                            ...
                            if len(line) > 120:
                                for i in range(0, len(line), 120):
                                    pdf.multi_cell(0, 8, line[i:i+120])
                            else:
