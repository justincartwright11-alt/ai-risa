        ...
        for bout in bout_entries:
            ...
            if fight_report:
                ...
                section_lines.extend([
                    ...
                    "|---|---|---|",
                    f"| Name | {fight_report.get('fighter_a_name', '')} | {fight_report.get('fighter_b_name', '')} |",
                    f"| Profile | {fight_report.get('fighter_a_profile_summary', '')} | {fight_report.get('fighter_b_profile_summary', '')} |",
                    "",
                ])
                ...
                section_lines.extend([
                    ...
                    "| Lens | Summary |",
                    "|---|---|",
                    f"| Decision structure | {fight_report.get('decision_structure', '')} |",
                    f"| Energy use | {fight_report.get('energy_use', '')} |",
                    f"| Fatigue failure points | {fight_report.get('fatigue_failure_points', '')} |",
                    f"| Mental condition | {fight_report.get('mental_condition', '')} |",
                    f"| Collapse triggers | {fight_report.get('collapse_triggers', '')} |",
                    f"| Main tactical edge | {fight_report.get('main_tactical_edge', '')} |",
                    "",
                ])
