...
BUTTON1_MULTISPORT_EVENT_CARD_FIXTURES_V1: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "fighter_a": "Superlek Kiatmoo9",
        "fighter_b": "Rodtang Jitmuangnon",
...
def prepare_event_card_fixture_for_button1_v1(fixture_row: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not classification or classification.get("sport") != sport:
        return {
            ...
            "event_name": fixture.get("event_name") or "Unknown Event",
            "event_date": fixture.get("event_date") or "",
            "promotion": fixture.get("promotion") or "",
            "fighter_a": fixture.get("fighter_a") or "",
            "fighter_b": fixture.get("fighter_b") or "",
            "source_type": fixture.get("source_type") or "unknown",
            "sport": sport,
    ...
    return {
        ...
        "fighter_a": fixture.get("fighter_a"),
        "fighter_b": fixture.get("fighter_b"),
        "source_type": fixture.get("source_type") or "official",
        "sport": sport,
