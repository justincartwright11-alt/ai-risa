...
def button1_to_button2_dossier_handoff_preview():
    ...
    build_button1_to_button2_readonly_dossier_handoff_preview = _lazy_button1_to_button2_readonly_dossier_handoff_preview()
...
def button2_dossier_handoff_report_context_preview():
    ...
    build_button2_dossier_handoff_report_context_preview = _lazy_button2_dossier_handoff_report_context_preview()
    body = request.get_json(silent=True)
    if body is None:
        body = {}
    if not isinstance(body, dict):
