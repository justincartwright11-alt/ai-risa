"""
Button 2 Customer PDF - Phase 4 Chart/Scenario Rendering Smoke v1

Evidence-only smoke proof that chart/scenario rendering polish remains CSS-only,
preserves contracts, and introduces no operational behavior changes.
"""
...
def _valid_ctx(**overrides):
    base = {
        ...
        "fight_id": "fight_phase4_chart_scenario_smoke_001",
        "source_context_kind": "button1_dossier_handoff",
        "source_ingest_mode": "preview_only",
        "handoff_summary_preview": "Phase 4 chart/scenario rendering smoke keeps contracts stable.",
        "hierarchy_markers": [
...
def test_chart_scenario_render_css_remains_present():
...
def test_severity_styling_remains_represented():
    html = build_button2_report_html(_valid_ctx())["html_content"]
...
def test_chart_scenario_metadata_remains_intact():
    html = build_button2_report_html(_valid_ctx())["html_content"]
