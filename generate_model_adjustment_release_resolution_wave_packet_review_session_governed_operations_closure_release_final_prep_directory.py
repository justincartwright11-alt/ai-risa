# v64.91 closure-release-final-prep-directory generator
# Pure downstream projection from v64.90 manifest
...
def main():
    ...
    with OUTPUT_MD_PATH.open("w", encoding="utf-8") as f:
        f.write(f"# v64.91 Closure Release Final Prep Directory\n\n")
