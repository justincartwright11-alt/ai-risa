...
<#
.SYNOPSIS
    Run AI-RISA latest-run alert check and write deterministic ops artifacts.
#>
...
$logFile = Join-Path $LogDir 'latest_run_alert_check.log'
...
try {
    ...
    Write-Log -LogFile $logFile -Message '=== AI-RISA Ops: Latest Run Alert Check ==='
