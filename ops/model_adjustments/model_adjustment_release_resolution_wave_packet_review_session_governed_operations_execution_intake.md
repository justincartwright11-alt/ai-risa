# model_adjustment_release_resolution_wave_packet_review_session_governed_operations_execution_intake

Source artifact: `ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_dispatch_handoff.json`
Record count: 1

| Execution Intake ID | Source Dispatch-Handoff ID | Source Record Index |
|--------------------|---------------------------|---------------------|
| resolution-wave-packet-review-session-governed-operations-execution-intake-0001 | resolution-wave-packet-review-session-governed-operations-dispatch-handoff-0001 | 1 |

## resolution-wave-packet-review-session-governed-operations-execution-intake-0001
Source dispatch-handoff ID: resolution-wave-packet-review-session-governed-operations-dispatch-handoff-0001
