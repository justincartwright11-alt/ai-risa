# v44.2 Governed Operations Receipt Assessment

Source artifact: ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_receipt_intake.json

Record count: 1

| governed_operations_receipt_assessment_id | source_governed_operations_receipt_intake_id | source_record_index |
|---|---|---|
| resolution-wave-packet-review-session-governed-operations-receipt-assessment-0001 | resolution-wave-packet-review-session-governed-operations-receipt-intake-0001 | 1 |

## resolution-wave-packet-review-session-governed-operations-receipt-assessment-0001
Source receipt-intake ID: resolution-wave-packet-review-session-governed-operations-receipt-intake-0001

Source record index: 1

Receipt intake record (verbatim):
