# v44.1 Governed Operations Receipt Intake

Source artifact: ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_cadence_handoff.json

Record count: 1

| governed_operations_receipt_intake_id | source_governed_operations_cadence_handoff_id | source_record_index |
|---|---|---|
| resolution-wave-packet-review-session-governed-operations-receipt-intake-0001 | resolution-wave-packet-review-session-governed-operations-cadence-handoff-0001 | 1 |

## resolution-wave-packet-review-session-governed-operations-receipt-intake-0001
Source handoff ID: resolution-wave-packet-review-session-governed-operations-cadence-handoff-0001

Source record index: 1

Cadence handoff record (verbatim):
