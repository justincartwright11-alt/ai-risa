# v44.3 Governed Operations Receipt Handoff

Source artifact: ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_receipt_assessment.json

Record count: 1

| governed_operations_receipt_handoff_id | source_governed_operations_receipt_assessment_id | source_record_index |
|---|---|---|
| resolution-wave-packet-review-session-governed-operations-receipt-handoff-0001 | resolution-wave-packet-review-session-governed-operations-receipt-assessment-0001 | 1 |

## resolution-wave-packet-review-session-governed-operations-receipt-handoff-0001
Source receipt-assessment ID: resolution-wave-packet-review-session-governed-operations-receipt-assessment-0001

Source record index: 1

Receipt assessment record (verbatim):
