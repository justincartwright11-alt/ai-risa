...
INPUT_PATH = Path(r"ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_closure_release_final_prep_prep_map.json")
OUTPUT_JSON_PATH = Path(r"ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_closure_release_final_prep_prep_register.json")
OUTPUT_MD_PATH = Path(r"ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_closure_release_final_prep_prep_register.md")

ID_PREFIX = "resolution-wave-packet-review-session-governed-operations-closure-release-final-prep-prep-register-"
...
for idx, record in enumerate(input_records_sorted, 1):
    register_id = f"{ID_PREFIX}{idx:04d}"
    register_record = {
        "id": register_id,
...
with OUTPUT_MD_PATH.open("w", encoding="utf-8") as f:
    f.write("# closure-release-final-prep-prep-register\n\n")
