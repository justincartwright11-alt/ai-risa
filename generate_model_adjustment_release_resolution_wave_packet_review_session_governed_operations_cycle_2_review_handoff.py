#!/usr/bin/env python3
"""
generate_model_adjustment_release_resolution_wave_packet_review_session_governed_operations_cycle_2_review_handoff.py

Purpose: Deterministically generate the v41.2 governed operations cycle 2 review handoff artifact from the frozen review intake and assessment.
...
- ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_cycle_2_review_handoff.md

Rules:
- review family only
- do not reopen or mutate v8.8 through v41.1
- handoff only
...
def main():
    ...
    assessment_path = Path("ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_cycle_2_review_assessment.json")

    # Output paths
    handoff_json_path = Path("ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_cycle_2_review_handoff.json")
    handoff_md_path = Path("ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_cycle_2_review_handoff.md")
    ...
    # Compose handoff record (using provided contract and operator placeholders)
    record = {
        "governed_operations_cycle_2_review_handoff_id": "resolution-wave-packet-review-session-governed-operations-cycle-2-review-handoff-0001",
        "governed_operations_cycle_2_review_assessment_id": assessment_rec["governed_operations_cycle_2_review_assessment_id"],
        "handoff_position": 1,
        ...
        "lineage_source_layer": "governed_operations_cycle_2_review_assessment",
        "lineage_source_file": str(assessment_path).replace("\\", "/"),
        "lineage_source_record_id": assessment_rec["governed_operations_cycle_2_review_assessment_id"]
    }

    contract = {
        "record_type": "model_adjustment_release_resolution_wave_packet_review_session_governed_operations_cycle_2_review_handoff",
        "source_files": [
            str(intake_path).replace("\\", "/"),
            str(assessment_path).replace("\\", "/")
        ],
        "frozen_slices": [
            "v41.0-controlled-release-resolution-wave-packet-review-session-governed-operations-cycle-2-review-intake",
            "v41.1-controlled-release-resolution-wave-packet-review-session-governed-operations-cycle-2-review-assessment"
        ],
        "governed_operations_cycle_2_review_intake_complete": True,
        "governed_operations_cycle_2_review_assessment_complete": True,
        "governed_operations_cycle_2_review_handoff_complete": True,
    ...
    with handoff_md_path.open("w", encoding="utf-8") as f:
        f.write("# v41.2 Governed Operations Cycle 2 Review Handoff\n\n")
