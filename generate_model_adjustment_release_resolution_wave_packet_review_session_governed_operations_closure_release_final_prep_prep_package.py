...
INPUT_PATH = Path(r"ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_closure_release_final_prep_prep_archive.json")
OUTPUT_JSON_PATH = Path(r"ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_closure_release_final_prep_prep_package.json")
OUTPUT_MD_PATH = Path(r"ops/model_adjustments/model_adjustment_release_resolution_wave_packet_review_session_governed_operations_closure_release_final_prep_prep_package.md")

ID_PREFIX = "resolution-wave-packet-review-session-governed-operations-closure-release-final-prep-prep-package-"
...
for idx, record in enumerate(input_records_sorted, 1):
    package_id = f"{ID_PREFIX}{idx:04d}"
    package_record = {
        "id": package_id,
...
with OUTPUT_MD_PATH.open("w", encoding="utf-8") as f:
    f.write("# closure-release-final-prep-prep-package\n\n")
