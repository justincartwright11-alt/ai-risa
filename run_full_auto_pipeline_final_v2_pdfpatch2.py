# PDF patch with markdown sanitization before rendering
# Cleans up problematic lines before PDF export
...
def sanitize_markdown_for_pdf(md):
    ...
    for line in md.split('\n'):
        ...
        if line.strip().startswith('|') and len(line) > 120:
            # Split table row into cells, join with ' | '
