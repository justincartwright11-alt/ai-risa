# v64.72 closure-release-final-prep-manifest generator
# Pure downstream projection from closure-release-final-prep-index
...
def main():
    ...
    with OUTPUT_MD_PATH.open("w", encoding="utf-8") as f:
        f.write(f"# v64.72 closure-release-final-prep-manifest\n\n")
